...
def main():
    ...
    decisions, sources, decision_paths = load_decisions(args.decision_dir)
    ...
    reviewed_path = args.output_dir / "all_codex_reviewed_child_blocks.json"
    retained_path = args.output_dir / "retained_table_description_child_blocks.json"
    readable_path = args.output_dir / "codex_reviewed_child_blocks_readable.md"
    jsonl_path = args.output_dir / "codex_reviewed_parent_child_samples.jsonl"
    ...
    status_path = args.output_dir / "codex_child_review_status.json"
